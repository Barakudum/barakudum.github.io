...
export default class PythonPackages extends React.Component {
    ...
    render(){
        return <div className="top-hr python-packages parallax">
...
class Package extends React.Component {
    ...
    render(){
        ...
        return <FlipCard>
            ...
            <div className="python-package-card-back local-footer-container">
                <p className="description">{project.description ?? "no description available"}</p>
                <p>
                    {project.pypi_name ?
                        <>Installation: <code>pip install {project.pypi_name}</code> {project.pip_installable === false && "soon"}</>
                        :
